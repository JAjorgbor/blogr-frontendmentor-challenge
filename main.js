...
let dropDownArrow = Array.from(
  document.querySelectorAll(".item_heading_drop_image")
);
...
function myFunction(x) {
  if (x.matches) {
    for (let i = 0; i < dropDownArrow.length; i++) {
      document
        .querySelectorAll(".item_heading_drop_image")
        [i].setAttribute("src", "./images/icon-arrow-dark.svg");
    }
    document
      .querySelector(".flex-item-image img")
      .setAttribute("src", "./images/illustration-editor-mobile.svg");
    document
      .querySelector(".container3 .flex-item-image img")
      .setAttribute("src", "./images/illustration-laptop-mobile.svg");
  } else {
    for (let i = 0; i < dropDownArrow.length; i++) {
      document
        .querySelectorAll(".item_heading_drop_image")
        [i].setAttribute("src", "./images/icon-arrow-light.svg");
    }
    document
      .querySelector(".flex-item-image img")
      .setAttribute("src", "./images/illustration-editor-desktop.svg");
    document
      .querySelector(".container3 .flex-item-image img")
      .setAttribute("src", "./images/illustration-laptop-desktop.svg");
  }
}
